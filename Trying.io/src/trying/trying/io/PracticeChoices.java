 ...
 * @author Asus
 */
public class PracticeChoices extends javax.swing.JFrame {

    /**
     * Creates new form PracticeChoices1
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PracticeChoices.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PracticeChoices().setVisible(true);
            }
        });
    }
